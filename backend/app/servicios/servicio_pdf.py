...
class ServicioPDF:
    ...
    def _build_header(self, titulo: str, numero: str, fecha: str,
                      fecha_vencimiento: Optional[str] = None) -> list:
        """Construye el header del documento."""
        elements = []

        # Nombre empresa
        elements.append(Paragraph(
            self.tenant.get('nombre', 'Empresa'),
        ...
        doc_info = [[
            ...
            Paragraph(
                f"<b>No:</b> {numero}<br/>"
                f"<b>Fecha:</b> {fecha}"
                + (f"<br/><b>Vence:</b> {fecha_vencimiento}" if fecha_vencimiento else ""),
    ...
    def _build_totales(self, subtotal, descuento, base_gravable, total_iva, total,
                        descuento_global_pct=None) -> list:
    ...
    def generar_factura_pdf(
        ...
        cliente: dict,
        detalles: list,
        subtotal, descuento, base_gravable, total_iva, total,
        ...
        elements.extend(self._build_totales(subtotal, descuento, base_gravable, total_iva, total,
