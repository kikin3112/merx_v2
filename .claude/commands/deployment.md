...
curl -X POST http://localhost:8000/api/v1/auth/login \
  ...
  -d '{"email":"admin@velasaromaticas.com","password":"admin123"}'
```
...
```bash
DB_URL=postgresql://postgres:kikin3112@localhost:5432/api_merx_v2
DB_POOL_SIZE=10
DB_MAX_OVERFLOW=20
SECRET_KEY=desarrollo_api_merx_v2_secret_key_minimo_32_caracteres_aqui
ALGORITHM=HS256
