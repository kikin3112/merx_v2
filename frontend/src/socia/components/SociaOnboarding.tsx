...
const PASOS_CONVERSACION: MensajeSocia[] = [
  {
    texto: '¡Hola! Soy Socia, tu asistente de precios 🕯️ Estoy aquí para ayudarte a ponerle el precio justo a cada vela para que tu negocio crezca y nunca trabajes a pérdida.',
    opciones: ['¡Hola Socia!', 'Cuéntame más'],
  },
  {
    texto: '¿Ya tienes claro cuánto te cuesta hacer una vela?',
    opciones: ['Más o menos', 'No tengo ni idea', 'Creo que sí'],
  },
  {
    texto: 'Perfecto. Te ayudo con eso en las recetas 💡 Ahí registras los ingredientes, tu tiempo y tus gastos. Yo hago los cálculos por ti.',
    opciones: ['¿Y los gastos del negocio?', '¿Cómo empiezo?'],
  },
  {
    texto: '¡Buena pregunta! El gas, los empaques, la luz... también cuentan. Los agregas en "Gastos adicionales" y yo los reparto automáticamente entre todas tus velas.',
    opciones: ['¡Eso es muy útil!', 'Entendido'],
  },
  {
    texto: '¿Lista para empezar? Crea tu primera receta y descubre cuánto te cuesta cada vela. ¡Juntas ponemos a crecer tu negocio! 🚀',
    opciones: ['¡Vamos!'],
    accion: 'completar',
  },
];
